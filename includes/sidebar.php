...
?>
 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="<?php echo getLogoUrl(); ?>" alt="Logo" class="brand-image">
</a>
...
function getLogoUrl()
{
    ...
    if ($logoResult->num_rows > 0) {
        ...
        return 'dist/img/sambandh-square.png';
    }
}
?>
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/sambandh-square.png" class="imgelevation-2" alt="User Image">
        </div>
    </div>
